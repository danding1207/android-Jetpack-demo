...
import com.msc.someweather.view.ObservableHorizontalScrollView;
import com.msc.someweather.view.ScrollState;

/**
 * Callbacks for Scrollable widgets.
 */
public interface ObservableHorizontalScrollViewCallbacks {
    /**
     ...
     *
     * @param scrollX     Scroll position in X axis.
     ...
     */
    void onScrollChanged(ObservableHorizontalScrollView scrollView, int scrollX, boolean firstScroll, boolean dragging);
