...
import com.google.samples.apps.sunflower.utilities.PermissionsUtils
...
class WeatherViewModel(private val fragment: Fragment) : ViewModel() {
    ...
    var locationLiveObservableData = MutableLiveData<Location>()
    var weatherLocationLiveObservableData = MutableLiveData<WeatherLocation.HeWeather6Bean.BasicBean>()
    var nowWeatherLiveObservableData = MutableLiveData<NowWeather.HeWeather6Bean.NowBean>()
    var forecastLiveObservableData = MutableLiveData<Forecast.HeWeather6Bean>()
    var lifestyleLiveObservableData = MutableLiveData<Lifestyle.HeWeather6Bean>()

    init {
        //这里的trigger为网络检测，也可以换成缓存数据是否存在检测
        locationLiveObservableData = switchMap<Boolean, Location>(
                PermissionsUtils.isGranted(fragment.context!!, Manifest.permission.ACCESS_FINE_LOCATION)
        ) { hasPermissions ->
            if (!hasPermissions) {

            }
            val applyData = MutableLiveData<Location>()
            getLocation()
            applyData
        } as MutableLiveData<Location>
    }
    ...
    fun getLocation() {
        ...
        val manager = fragment.context!!.getSystemService(Context.LOCATION_SERVICE) as LocationManager
...
//                            val locality = address.locality//得到城市
                            //要获得哪些信息自己看咯
                            locationLiveObservableData.value = location
    ...
    fun initCity(value: String) {
        ...
        DataRepository.searchLocation(url)
                ...
                .subscribe(object : Observer<WeatherLocation> {
                    override fun onSubscribe(d: Disposable) {

                    }

                    override fun onNext(value: WeatherLocation) {
                        ...
                        if (value.HeWeather6 != null &&
                            ...
                            weatherLocationLiveObservableData.value = value.HeWeather6!![0].basic!![0]
                ...
                .subscribe(object : Observer<NowWeather> {
                    ...
                    override fun onNext(value: NowWeather) {
                        ...
                        if (value.HeWeather6 != null &&
                            ...
                            nowWeatherLiveObservableData.value = value.HeWeather6!![0].now
...
//                                            + "\n云量：${value.HeWeather6!![0].now!!.cloud}")
    ...
    fun initForecastWeather(cityID: String) {
                ...
                .subscribe(object : Observer<Forecast> {
                    ...
                    override fun onNext(value: Forecast) {
                        ...
                        if (value.HeWeather6 != null &&
                            ...
                            forecastLiveObservableData.value = value.HeWeather6!![0]
...
//                            }
    ...
    fun initLifestyle(cityID: String) {
                ...
                .subscribe(object : Observer<Lifestyle> {
                    ...
                    override fun onNext(value: Lifestyle) {
                        ...
                        if (value.HeWeather6 != null &&
                            ...
                            lifestyleLiveObservableData.value = value.HeWeather6!![0]
