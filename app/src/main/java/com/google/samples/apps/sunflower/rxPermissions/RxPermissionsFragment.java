package com.google.samples.apps.sunflower.rxPermissions;
...
public class RxPermissionsFragment extends Fragment {
    ...
    void onRequestPermissionsResult(String[] permissions, int[] grantResults, boolean[] shouldShowRequestPermissionRationale) {
        ...
        for(int size = permissions.length; i < size; ++i) {
            ...
            if (subject == null) {
                Logger.e("RxPermissions.onRequestPermissionsResult invoked but didn't find the corresponding permission request.");
                return;
            }
